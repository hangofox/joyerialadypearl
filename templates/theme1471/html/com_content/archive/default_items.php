			...
			<div class="item">
					...
					<?php if ($params->get('show_publish_date')) : ?>
							<div class="item_published">
								<span><?php echo JText::sprintf(JHtml::_('date', $item->publish_up, JText::_('DATE_FORMAT_TPL2'))); ?></span>
								<?php echo JText::sprintf(JHtml::_('date', $item->publish_up, JText::_('DATE_FORMAT_TPL3'))); ?>
							</div>
					<?php endif; ?>
