...
<form id="searchForm" action="<?php echo JRoute::_('index.php?option=com_search');?>" method="post">
	...
	<div class="btn-toolbar">
		...
		<div class="btn-group pull-left">
			<button name="Search" onclick="this.form.submit()" class="btn hasTooltip btn-primary" title="<?php echo JText::_('COM_SEARCH_SEARCH');?>"><?php echo JText::_('COM_SEARCH_SEARCH');?></button>
		</div>
