      ...
      <div class="controls">
        <?php if (!$params->get('usetext')) : ?>
          <div class="input-prepend">
            ...
            <input type="text" name="username" tabindex="0" size="18" placeholder="<?php echo JText::_('MOD_LOGIN_VALUE_USERNAME') ?>" required />
          </div>
        <?php else: ?>
      ...
      <div class="controls">
        <?php if (!$params->get('usetext')) : ?>
          <div class="input-prepend">
            ...
            <input type="password" name="password" tabindex="0" size="18" placeholder="<?php echo JText::_('JGLOBAL_PASSWORD') ?>" required />
          </div>
        <?php else: ?>
...
<script>
  jQuery(function($){
    $('.moduletable#module_<?php echo $module->id; ?>>i.fa-user').click(function(){
      $('.moduletable#module_<?php echo $module->id; ?>').toggleClass('shown')
    });
      $(document).on('click touchmove',function(e) {
          var container = $(".moduletable#module_<?php echo $module->id; ?>");
