...
class HelixUltimateFeatureMenu
{
	...
	public function renderLogin()
	{
		...
		if ($user->id === 0)
		{
			$html[] = '<a class="sp-sign-in" href="' . Route::_('index.php?option=com_users&view=login') . '" ><span class="far fa-user me-1" aria-hidden="true"></span><span class="signin-text d-none d-lg-inline-block">' . Text::_('HELIX_ULTIMATE_SIGN_IN_MENU') . '</span></a><a class="sp-register" href="' . Route::_('index.php?option=com_users&view=registration') . '" ><span class="far fa-user me-1" aria-hidden="true"></span><span class="register-text d-none d-lg-inline-block">' . Text::_('HELIX_ULTIMATE_REGISTRATION_MENU') . '</span></a>';
		}
		else
		{
